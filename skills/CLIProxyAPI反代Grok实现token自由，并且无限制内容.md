反代XAI实现token自由，并且无限制内容

![a8acc6fa55f794a8dd89180ef7e4a07e.png](../_resources/a8acc6fa55f794a8dd89180ef7e4a07e.png)

教程是把CLIProxyAPI使用Docker部署到服务器实现24小时调用自由，还可以共享给朋友，同事等

![3832b2ca64da72076cb50108c41078c0.png](../_resources/3832b2ca64da72076cb50108c41078c0.png)

项目地址：https://github.com/router-for-me/CLIProxyAPI

服务器部署，不要选择国内地区，选择Linux版本Docker上手快
...
1.Ubuntu24系统先一个文件夹来存储文件，名字是CLIProxyAPI，并打开
...
![b7a83e43803546161a0241090577810e.png](../_resources/b7a83e43803546161a0241090577810e.png)

2.创建配置文件，路径是/home/ubuntu/CLIProxyAPI/config.yaml

```
touch config.yaml
```

![9cb839e88df45c68c6d481d4deb7dbcd.png](../_resources/9cb839e88df45c68c6d481d4deb7dbcd.png)
...
![e744529f4526f27778ee5651cdf56d21.png](../_resources/e744529f4526f27778ee5651cdf56d21.png)

4.修改 allow-remote: false为true， secret-key: ""填入123456，服务器部署密码一定要复杂！！！我这里是教程示例

![08c6fc7da01aaac00fa97b0883eb25ad.png](../_resources/08c6fc7da01aaac00fa97b0883eb25ad.png)
...
![55120241b7dc413b00c5c83149e27cfa.png](../_resources/55120241b7dc413b00c5c83149e27cfa.png)
...
```
  ...
  ![e0910fedec8812a910394a12351503d3.png](../_resources/e0910fedec8812a910394a12351503d3.png)

7.浏览器访问，防火墙记得放通8317端口

http://你的服务器IP:8317/management.html

密码：123456 之前创建的

![5e83c80573822213690834858469ec33.png](../_resources/5e83c80573822213690834858469ec33.png)

8.XAI为例，OAuth登录

![06ff66f10747b7142ddc50bf966d6b6b.png](../_resources/06ff66f10747b7142ddc50bf966d6b6b.png)

9.登录XAI账号，把链接复制到回调 URL

![50f889a37970d63ee2996356773b7eea.png](../_resources/50f889a37970d63ee2996356773b7eea.png)

复制进去后点击提交回调URL

![1d9ca119d2cfc26f375928138540ba27.png](../_resources/1d9ca119d2cfc26f375928138540ba27.png)

10.认证文件会成功出现

![4a1034cf54ade2c7ab7fe994c133d51e.png](../_resources/4a1034cf54ade2c7ab7fe994c133d51e.png)

11.信息中心就是可以调用的模型

![96b91997c80d12f6af8064fbc0492602.png](../_resources/96b91997c80d12f6af8064fbc0492602.png)

接口：http://你的服务器IP:8317/v1

模型：grok-4.3

12.如何更新项目，直接执行下面的命令，密钥都不会改变，只要重新登录一遍OAuth即可
...
```
  ...
  ![7c98e1d190c64c2082281dc6e898f197.png](../_resources/7c98e1d190c64c2082281dc6e898f197.png)
